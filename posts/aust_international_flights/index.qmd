...
This is a pretty brief look - might try it in Shiny where it will probably come together better. The biggest challenge was the great circle mapping, the solution to which was pretty much right in front of me on ['the R Graph Gallery'](https://r-graph-gallery.com/how-to-draw-connecting-routes-on-map-with-r-and-great-circles.html)...
